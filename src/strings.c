...
const u8 gText_DecideStop[] = _("{A_BUTTON}OK {B_BUTTON}ANNULER");
const u8 gText_ReceiveMysteryGiftWithEReader[] = _("Lisez vos e-cards CADEAU MYST.\navec l’e-Reader. Pour se connecter,");
const u8 gText_SelectConnectFromEReaderMenu[] = _("sélectionnez l’option “Communication”\ndans le menu du e-Reader.");
const u8 gText_SelectConnectWithGBA[] = _("Puis sélectionnez l’option\n“To Game Boy Advance”.");
const u8 gText_SelectConnectAndPressA[] = _("Sélectionnez “Connect” sur l’\ne-Reader et appuyez sur le bouton A.");
const u8 gText_LinkIsIncorrect[] = _("Connexion invalide.");
const u8 gText_CardReadingHasBeenHalted[] = _("Interruption de la lecture de carte.");
const u8 gText_UnableConnectWithEReader[] = _("Echec de connexion à l’e-Reader.");
const u8 gText_Connecting[] = _("Connexion...");
const u8 gText_ConnectionErrorCheckLink[] = _("Erreur de communication…\nVeuillez vérifier la connexion.");
const u8 gText_ConnectionErrorTryAgain[] = _("Erreur de transmission.\nVeuillez réessayer.");
const u8 gText_AllowEReaderToLoadCard[] = _("Veuillez scanner les cartes\navec l’e-Reader.");
const u8 gText_ConnectionComplete[] = _("Transfert terminé!");
const u8 gText_NewTrainerHasComeToHoenn[] = _("Des nouveaux DRESSEURS sont arrivés\ndans la région de HOENN.");
const u8 gText_PleaseWaitAMoment[] = _("Veuillez patienter...");
const u8 gText_WriteErrorUnableToSaveData[] = _("Erreur de lecture.\nEchec de la sauvegarde...");
...
const u8 gText_Friend[] = _("Friend");
const u8 gText_Pokemon3[] = _("POKeMON");
const u8 gText_DecideStop[] = _("{A_BUTTON}OK {B_BUTTON}CANCEL");//Translation needed. atm this is an english place holder
const u8 gText_ReceiveMysteryGiftWithEReader[] = _("Here, you can read MYSTERY GIFT\ncards with the e-Reader.");//Translation needed. atm this is an english place holder
const u8 gText_SelectConnectFromEReaderMenu[] = _("To connect, choose the “Communication”\noption from the e-Reader menu.");//Translation needed. atm this is an english place holder
const u8 gText_SelectConnectWithGBA[] = _("Then select the option\n“To Game Boy Advance”.");//Translation needed. atm this is an english place holder
const u8 gText_SelectConnectAndPressA[] = _("Select “Connect” on the e-Reader\nand press the A button.");//Translation needed. atm this is an english place holder
const u8 gText_LinkIsIncorrect[] = _("The link is invalid.");//Translation needed. atm this is an english place holder
const u8 gText_CardReadingHasBeenHalted[] = _("Stopped reading the card.");//Translation needed. atm this is an english place holder
const u8 gText_UnableConnectWithEReader[] = _("Unable to connect to the e-Reader.");//Translation needed. atm this is an english place holder
const u8 gText_Connecting[] = _("Connecting…");//Translation needed. atm this is an english place holder
const u8 gText_ConnectionErrorCheckLink[] = _("Communication error.\nPlease check the connection.");//Translation needed. atm this is an english place holder
const u8 gText_ConnectionErrorTryAgain[] = _("Communication error.\nPlease try again.");//Translation needed. atm this is an english place holder
const u8 gText_AllowEReaderToLoadCard[] = _("Please scan the card into\nthe e-Reader.");//Translation needed. atm this is an english place holder
const u8 gText_ConnectionComplete[] = _("Transfer complete!");//Translation needed. atm this is an english place holder
const u8 gText_NewTrainerHasComeToHoenn[] = _("A new TRAINER has arrived in HOENN.");//Translation needed. atm this is an english place holder
const u8 gText_PleaseWaitAMoment[] = _("Please wait…");//Translation needed. atm this is an english place holder
const u8 gText_WriteErrorUnableToSaveData[] = _("Write error.\nData could not be saved.");//Translation needed. atm this is an english place holder
...
const u8 gText_Friend[] = _("Friend");
const u8 gText_Pokemon3[] = _("POKeMON");
const u8 gText_DecideStop[] = _("{A_BUTTON}OK {B_BUTTON}CANCELAR");
const u8 gText_ReceiveMysteryGiftWithEReader[] = _("Aquí puedes leer cartas de REGALO\n MISTERIOSO con el e-Reader.");
const u8 gText_SelectConnectFromEReaderMenu[] = _("Para conectarte, elige la opción “Communication”\ndel menú del e-Reader.");
const u8 gText_SelectConnectWithGBA[] = _("Elige la opción \n“To Game Boy Advance”.");
const u8 gText_SelectConnectAndPressA[] = _("Selecciona “Connect” en el e-Reader\n y pulsa el botón A.");
const u8 gText_LinkIsIncorrect[] = _("Conexión invalida.");
const u8 gText_CardReadingHasBeenHalted[] = _("Interrupcion de lectura de carta");
const u8 gText_UnableConnectWithEReader[] = _("Incapaz de conectar al e-Reader");
const u8 gText_Connecting[] = _("Conectando...");
const u8 gText_ConnectionErrorCheckLink[] = _("Error de comunicación.\nComprueba la conexión.");
const u8 gText_ConnectionErrorTryAgain[] = _("Error de comunicación.\nInténtalo de nuevo.");
const u8 gText_AllowEReaderToLoadCard[] = _("Escanea la carta en \nel e-Reader.");
const u8 gText_ConnectionComplete[] = _("¡Transferencia completada!");
const u8 gText_NewTrainerHasComeToHoenn[] = _("Un nuevo ENTRENADOR ha llegado a HOENN.");
const u8 gText_PleaseWaitAMoment[] = _("Esperando...");
const u8 gText_WriteErrorUnableToSaveData[] = _("Error de escritura.\nNo se pudieron guardar los datos.");
...
const u8 gText_LeaderBoardTrainerName[] = _("----------");
const u8 gText_LeaderBoardTrainerClass[] = _("------------");
